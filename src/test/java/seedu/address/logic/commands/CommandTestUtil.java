...
public class CommandTestUtil {
    ...
    public static final String VALID_TAG_POOR = "POOR";
    ...
    public static final String INVALID_COURSE_DESC = " " + PREFIX_COURSE + "911a"; // courses should start with alphabetical prefix
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_COURSE_AMY).withEmail(VALID_EMAIL_AMY)
                .withTags(TAG_DESC_POOR).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_COURSE_BOB).withEmail(VALID_EMAIL_BOB)
                .withTags(TAG_DESC_GOOD).build();
    }
